    ...
    <div className="min-h-screen h-full flex flex-col lg:flex-row items-stretch bg-[#0f172a] font-sans overflow-hidden">
      ...
      <div className="flex flex-1 flex-col justify-center items-center w-full lg:w-1/2 min-w-0 bg-[#0f172a] px-0 py-6 lg:py-10 lg:px-0 order-1 lg:order-none relative">
        ...
        <div className="flex flex-col items-center justify-center w-full">
          {/* Illustration - responsive container */}
          <div
            className="flex justify-center items-center w-full mb-4 lg:mb-6 lg:ml-32"
            style={{ minHeight: 0 }}
          >
            <img
              src={illustration}
          ...
          {/* Quote */}
          <div className="text-center text-[#94a3b8] text-base leading-relaxed w-full flex flex-col items-center mt-0 lg:mt-[-28px] lg:ml-32">
      ...
      <div className="flex flex-1 flex-col justify-center items-center w-full lg:w-1/2 px-0 py-0 lg:py-0 lg:pr-0 lg:pl-0 order-2 lg:order-none">
        <div className="w-full max-w-[500px] bg-[#1e293b] p-6 sm:p-8 md:p-10 rounded-none lg:rounded-[4px] shadow-none border-none overflow-visible select-none flex flex-col justify-center signup-container-no-margin mr-0 ml-0 outline-none" tabIndex={-1}>
          <div className="w-full max-w-md md:max-w-lg lg:max-w-xl mx-auto">
            ...
            <div className="flex items-center my-4 text-center text-[#94a3b8] font-semibold text-base w-full">
            ...
            <div className="mt-3 text-center text-[#94a3b8] text-base">
